  ...
  if (submitted) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="text-4xl md:text-6xl font-syncopate font-bold mb-6">BOOKING RECEIVED</h1>
        ...
        <button 
          ...
          className="px-10 py-4 border border-white hover:bg-white hover:text-black transition-all font-bold tracking-widest uppercase text-xs"
        >
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <h2 className="text-red-500 font-syncopate text-sm mb-4 tracking-[0.5em]">RESERVATION</h2>
          <h1 className="text-5xl md:text-7xl font-syncopate font-bold mb-10 leading-none">RESERVE A SLOT</h1>
          ...
          <div className="space-y-8">
            <div className="p-6 bg-zinc-950 border border-white/10 flex items-start space-x-6">
              <div className="w-12 h-12 bg-white rounded flex items-center justify-center shrink-0">
                <Calendar className="text-black w-6 h-6" />
              </div>
              <div>
                <h4 className="font-bold tracking-widest mb-1">FLEXIBLE DATES</h4>
                <p className="text-sm text-gray-500">Pick a day that works. We operate Tuesday - Sunday, 10 AM to 8 PM.</p>
              </div>
            </div>
            <div className="p-6 bg-zinc-950 border border-white/10 flex items-start space-x-6">
              <div className="w-12 h-12 bg-white rounded flex items-center justify-center shrink-0">
              ...
              <div>
                <h4 className="font-bold tracking-widest mb-1">EXPERT ARTISTS</h4>
                <p className="text-sm text-gray-500">Nimesh, Piyumantha, and Vihan are available for custom commission work.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] tracking-widest font-bold text-gray-500 flex items-center">
            ...
            <div className="space-y-2">
              <label className="text-[10px] tracking-widest font-bold text-gray-500">TATTOO STYLE</label>
              <div className="flex flex-wrap gap-2">
                {['Blackwork', 'Realism', 'Cyberpunk', 'Geometric', 'Traditional'].map(s => (
                  <button
                    ...
                    className={`px-4 py-2 text-[10px] font-bold tracking-widest border transition-all ${
